...
const Canvas = ({ boardId }: CanvasProps) => {
  ...
  const translateSelectedLayer = useMutation(({storage,self},point:Point)=>{
    ...
    for(const id of self.presence.selection){
      ...
      if(layer){
        layer.update({x:layer.get("x") + offset.x
  ...
  const onPointerMouse = useMutation(
  ...
  const onLayerPointDown = useMutation(({ self,setMyPresence },e:React.PointerEvent,layerId:string)=>{
